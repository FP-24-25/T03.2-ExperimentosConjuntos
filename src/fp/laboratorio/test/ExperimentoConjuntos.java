...
public class ExperimentoConjuntos {
	...
	public static void main(String []args) {
		...
		//Añade el estudiante e2 al segundo conjunto y muestra el resultado de la operación add y el segundo conjunto
		
		
		// Añade el estudiante e3 al segundo conjunto y muestra el resultado de la operación add.
